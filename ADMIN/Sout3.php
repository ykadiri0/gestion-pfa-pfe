                                    ...
                                    <table width="800" height="500" border="0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <input type="text" name="PQ" value="Assad" id="textfield"></td>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" name="m2" class="custom-select" style="width:200px;" id="data"/>
                ...
                <nav id="menu">
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                            <li><a href="AjoutSjts.php">INSCRIPTION</a></li>
                                <li><a href="RendzVous.php">Rendez-vous</a></li>
