...
<body>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Ajouter Administrateurs :</a></li>
    ...
    border-bottom: 1px solid #b8bcfc;">
                                <strong class="card-title">Ajouter Administrateur :</strong>
                            </div>
                            <div class="card-body">
 ...
 border-radius: 5px 20px;
        ...
        ">
                                    ...
                                    <br>
                                    <form method="POST" action="php/ajadmin.php">
                                        ...
                                        <fieldset>
                                            <legend></legend><label for="pseudo">   Prenom : </label><br><input type="text" name="pseudo" placeholder="prenom" data-rule-required="true" data-msg-required="Le champ Pseudo est requis." /><span data-valmsg-for="pseudo"
                                                data-valmsg-replace="true"></span></fieldset><br>
                                                
                                        <fieldset>
                                            <legend></legend><label for="email">    Email : </label><br><input type="text" style="width:30%;" name="email" placeholder="bruno.lesieur@gmail.com" data-rule-required="true" data-msg-required="Le champ Email est requis." data-rule-email="true"
                                                data-msg-email="Le champ Email n'a pas le bon format." /><span data-valmsg-for="email" data-valmsg-replace="true"></span></fieldset><br>
                                        
                                        <fieldset><button type="submit" value="Valider" class="btn btn-success">Valider</button></fieldset>
                                            </th>
                                        </table>
