...
<body>
    ...
    border-bottom: 1px solid #b8bcfc;">
                                <strong class="card-title">home ajout :</strong>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p><strong>&nbsp;
                                    ...
                                    <button class="btn btn-outline-primary"><a href="ajoutUtilisateurs.php">Etudiant</a></button>
                                    <button class="btn btn-outline-primary"><a href="ajouterProf.php">Professeur</a></button>
                                    <button class="btn btn-outline-primary"><a href="ajouteradmin.php" >Admine</a></button>
                            </div>
                        </div>
                    </div>
                </div>
