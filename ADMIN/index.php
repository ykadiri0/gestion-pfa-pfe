                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="../avatars/<?php echo $_SESSION['avatar'] ?>"2 alt="User Avatar">
                        </a>
                        ...
                        <div class="container rounded bg-white mt-5 mb-5">
                            <div class="row">
                                <div class="col-md-3 border-right" style="background-color: #E6E6FA;">
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px"height="150px" src="../avatars/<?php echo $_SESSION['avatar'] ?>"><span class="font-weight-bold"><?php echo $_SESSION['nom'] ?></span><span class="text-black-50"><?php echo $_SESSION['username'] ?></span><span> </span></div>
                                </div>
                                <div class="col-md-5 border-right">
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12"><label class="labels">Email</label><input type="text" disabled class="form-control" value="<?php if(isset($_SESSION['username'])){ echo $_SESSION['username'];} ?>"></div>
                                            <div class="col-md-12"><label class="labels">Telephone</label><input type="text"  disabled class="form-control"  value="<?php if(isset($_SESSION['tel'])){  echo $_SESSION['tel'];} ?>"></div>
                                            <div class="col-md-12"><label class="labels">CIN</label><input type="text" class="form-control" disabled  value="<?php if(isset($_SESSION['CIN'])){  echo $_SESSION['CIN'] ;}?>"></div>

                                        </div>

                                        <div class="mt-5 text-center"><button class="btn btn-primary profile-button" onclick="window.location.href='updateprofile.php';" type="button">Update Profile</button></div>
                                    </div>
                                </div>
