...
<body>
    ...
    border-bottom: 1px solid #b8bcfc;">
                                <strong class="card-title">PFAs liste :</strong>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                  ...
                                  outline: none;">
                                        ...
                                        <select id="niveau" name="niveau" style="background-color:#b8bcfc; color:black;border-color: #b8bcfc; padding: 12px;
                                  width: 250px;
                                  border: none;
                                  font-size: 20px;
                                  box-shadow: 0 5px 25px rgba(0, 0, 0, 0.2);
                                            ...
                                            ajax.onreadystatechange = function() {
                                                if (this.readyState == 4 && this.status == 200) {
                                                    ...
                                                    for (var a = 0; a < data.length; a++) {
                                                        ...
                                                        var firstmem = data[a].Mbr1;
                                                        var firstid1 = data[a].id1;
                                                        var firstMbr2 = data[a].Mbr2;
                                                        var firstid2 = data[a].id2;
                                                        var firstMbr3 = data[a].Mbr3;
                                                        var firstid3 = data[a].id3;
                                                        ...
                                                        html += "<br><tr>";
                                                        html += "<td colspan=" + 5 + "><h3>" + firstsujet + "<h3></td>";
                                                        html += "</tr>";
                                                        ...
                                                        html += "<lu>"
                                                        html += "<li>" + firstmem + "</li>";
                                                        html += "<li>" + firstMbr2 + "</li>";
                                                        html += "<li>" + firstMbr3 + "</li>";
                                                        html += "</lu>"
                                                        html += "</td>";
                                                        html += "<td>" + firstfiliere + "</td>";
                                                        html += "<td>" + firstniveau + "</td>";
                                                        html += "<td>" + firstprofeseur + "</td>";
                                                        html += "</tr>";
                                                        html+="<tr>";
                                                        html+="<td><button class='btn btn-outline-warning'><a href='modifpfa.php?id="+firstidtri+"&sjts="+firstsujet+"&Mbr1="+firstmem+"&Mbr2="+firstMbr2+"&Mbr3="+firstMbr3+"&Professeur="+firstprofeseur+"&filiere="+firstfiliere+"'>modifier</a></button><button class='btn btn-outline-danger'><a href='php/deletepfa.php?id="+firstidtri+"'>Delete</a></button></td>"
                                                        html+="</tr>"
                                                        html += "<br>";
                                                    }
