 ...
 border-radius: 5px 20px;
        ...
        ">
                          ...
                          <fieldset>
                                  ...
                                  -webkit-appearance: button;
                                  appearance: button;
                                  outline: none;"><option <?php if(isset($_GET['niveau']) && $_GET['niveau']==="1ere annee"){echo "selected";} ?>>1ere annee</option><option <?php if(isset($_GET['niveau']) && $_GET['niveau']==="2ere annee"){echo "selected";} ?>>2eme annee</option <?php if(isset($_GET['niveau']) && $_GET['niveau']==="3ere annee"){echo "selected";} ?>>3eme annee</option></select>
