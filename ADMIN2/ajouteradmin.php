 ...
 border-radius: 5px 20px;
        ...
        ">
                                    ...
                                    <form method="POST" action="php/ajadmin.php">
                                        ...
                                        <fieldset>
                                            <legend></legend><label for="email">    Email : </label><br><input type="text" style="width:120%;" name="email" placeholder="bruno.lesieur@gmail.com" data-rule-required="true" data-msg-required="Le champ Email est requis." data-rule-email="true"
