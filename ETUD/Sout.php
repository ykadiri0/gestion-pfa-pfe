...
$sql = "SELECT * FROM notes WHERE id=" . $_SESSION['id'];
                            ...
                            <div class="card-body">
                                <form action="insert.php" method="GET">
                                    ...
                                    <?php
                                            ...
                                            ?>
                                        <div class="form-group"><label for="company" class=" form-control-label">Projet name:</label> <input name="pn" type="text" class="custom-select" value="<?php echo $rows['sjts']; ?>" style="width:600px;" id="data3" /></div>



                                        <div class="form-group"><label for="company" class=" form-control-label">Rapport :
                                            </label>
                                            <input type="text" name="PQ" value="<?php echo $rows['rapport']; ?>" id="textfield">

                                        </div>
                                        

                                        <div class="form-group"><label for="company" class=" form-control-label">La note :<input type='hidden' name='id2' id='id2'></label><?php
                                                        $servername = 'localhost';
                                                        $mysqli = new mysqli(
                                                            $servername,
                                                            $user,
                                                        ...
                                                        $result1 = "select sum(note)/3 AS 'N'  from notes where sjts=". $rows['sjts'];
                                                        $result2 = $mysqli->query($result1);
                                                        $mysqli->close();
                                                        ...
                                                        ?>
                                                         <?php
                                                                ...
                                                                ?>
                                                        <input type="number" name="m2" value="<?php echo $rows['N']; ?>" class="custom-select" style="width:200px;" id="data" />
                                                         <?php
                                            }
