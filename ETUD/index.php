            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <?php
                                        ...
                                        $sql2="SELECT * FROM `rapportpfe` WHERE professeur='".$_SESSION['nom']." ".$_SESSION["prenom"]."' ";
                                                ...
                                                $result2=mysqli_query($data,$sql2);
                                                          ...
                                                          if (mysqli_num_rows($result2) > 0) {
                                                                        while ($rows = mysqli_fetch_assoc($result2)) {
                                                                            echo'<table width="800" height="500" border="2">
                                                                            <tbody><tr><th scope="row" style="color:#1E56A0 ">Etudiant</th>
                                                                            <td><input type="text" disable value="'.$rows['etudiant'].'"></td>
                                                                            </tr>
                                                                            <tr><th scope="col" style="color:#1E56A0 ">&nbsp;Entreprise</th>
                                                                            <center>
                                                                                <td scope="col">&nbsp;<input type="text" disable value="'.$rows['entreprise'].'"></td>
                                                                            </center>
                                                                        </tr>
                                                                            <tr><th scope="col" style="color:#1E56A0 ">&nbsp;Description</th>
                                                                            <center>
                                                                                <td scope="col">&nbsp;<input type="text" disable value="'.$rows['description'].'"></td>
                                                                            </center>
                                                                        </tr>
                                                                        <th scope="row" style="color:#1E56A0 ">date du remise du rapport&nbsp;</th>
                                                                        <td><input type="text" disable value="'.$rows['daterapport'].'"></td>

                                                                        <tr>
                                                                        <th scope="row" style="color:#1E56A0">Rapport PFE&nbsp;</th>
                                                                        <td>
                                                                            <a href="../storage/rapportpfe/'.$rows['rapport'].'"  download>
                                                                                <button href="">Download Rapport</button>
                                                                        </td>
                                                                    </tr></table><br><br>'
                                                                        ;
                                                                        }
