                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><label for="select3"></label>
                                                        ...
                                                        <input name="pn" type="text" class="custom-select" value="<?php echo $rows['sjts']; ?>" style="width:600px;" id="data3" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <input type="text" name="PQ" value="<?php echo $rows['rapport']; ?>" id="textfield"></td>
                                                    </td>

                                                </tr>

                                                <tr>
                                                    <th scope="row">La note :<input type='hidden' name='id2' id='id2'></th>
                                                    <td><?php
                                                        $servername = 'localhost';
                                                        $mysqli = new mysqli(
                                                            $servername,
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="rapportE.php">Rapport</a></li>
