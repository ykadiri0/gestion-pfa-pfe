...
<body>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="ava.php">Tache PFA </a></li>
    ...
    border-bottom: 1px solid #b8bcfc;">
                                <strong class="card-title">Tache PFA</strong>
                            </div>
                            <div class="card-body">
   ...
   <div class="page-heading">
              <div class="container-fluid">
                <div class="row">
                          ...
                          ajax.onreadystatechange = function ()
                          {
                              if (this.readyState == 4 && this.status == 200) {
                                  ...
                                  for (var a = 0; a < data.length; a++) {
                                      var firstmem = data[a].sjts;
                                      var firstid1 = data[a].tache1;
                                      var firstMbr2 = data[a].description1;
                                      var firstid2 = data[a].tache2;
                                      var firstMbr3 = data[a].description2;
                                      var firstid3 = data[a].tache3;
                                      var firstMbr4 = data[a].description3;
                                      var firstid4 = data[a].deadline;
                                      html += "<tr>";
                                      html += "<td><h4>Sujet:</h4></td><td colspane=2><h3>" + firstmem + "</h3></td></tr>";
                                      html += "<tr>";
                                      html += "<td><h4>Tache 1:</h4></td><td>" + firstid1 + "</td>";
                                      html += "<td>" + firstMbr2 + "</td></tr>";
                                      html += "<tr>";
                                      html += "<td><h4>Tache 2:</h4></td><td>" + firstid2 + "</td>";
                                      html += "<td>" + firstMbr3 + "</td></tr>";
                                      html += "<tr>";
                                      html += "<td><h4>Tache 3:</h4></td><td>" + firstid3 + "</td>";
                                      html += "<td>" + firstMbr4 + "</td></tr>";
                                      html += "<tr>";
                                      html += "<td><h4>Date Limite :</h4></td><td colspane=2>" + firstid4 + "</td></tr>";
                                  }
                  ...
                  <button style="justify-content: center;"><a href="rapportE.php">deposer Rapport</a></button>
                  </div>
                </div>
            </div>
        </div>
