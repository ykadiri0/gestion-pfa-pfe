...
<body>
   ...
   <div class="breadcrumbs">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="trinome.php">Trinome :</a></li>
    ...
    border-bottom: 1px solid #b8bcfc;">
                                <strong class="card-title">equipe de PFA :</strong>
                            </div>
                            <div class="card-body">
   <div class="page-heading">
              <div class="container-fluid">
                <div class="row">
                  ...
                  <table border="0" id="bootstrap-data-table" class="table ">
                      <tbody id="data">
                                            ...
                                            ajax.onreadystatechange = function() {
                                                if (this.readyState == 4 && this.status == 200) {
                                                    ...
                                                    for (var a = 0; a < data.length; a++) {
                                                        ...
                                                        html += "<br><tr>";
                                                        html += "<td colspan=" + 5 + "><strong>Sujet</strong><br><br><h3>" + firstsujet + "<h3></td><br>";
                                                        html += "</tr>";
                                                        ...
                                                        html += "</tr></thead>";
                                                        html += "<tr>";
                                                        html += "<td>" + firstmem + "</td><br><td>" + firstfiliere + "</td><td>" + firstniveau + "</td><td>" + firstprofeseur + "</td>";
                                                        html += "</tr>";
                                                        html += "<tr>";
                                                        html += "<td>" + firstMbr2 + "</td><br>";
                                                        html += "</tr>";
                                                        html += "<tr>";
                                                        html += "<td>" + firstMbr3 + "</td><br>";
                                                        html += "</tr>";
                                                        html += "<br>";
                                                    }
