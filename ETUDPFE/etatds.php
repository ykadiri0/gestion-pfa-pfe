...
<body>
   ...
   <div class="breadcrumbs">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="trinome.php">etats des dossiers PFE</a></li>
    ...
    border-bottom: 1px solid #b8bcfc;">
                                <strong class="card-title">les ETATS des dossiers PFE :</strong>
                            </div>
                            <div class="card-body">
   <div class="page-heading">
              <div class="container-fluid">
                <div class="row">
                  ...
                  <form action="php/data4.php" method="GET">
                                            ...
                                            ajax.onreadystatechange = function() {
                                                if (this.readyState == 4 && this.status == 200) {
                                                    ...
                                                    for (var a = 0; a < data.length; a++) {
                                                        var firstidtri = data[a].dossier1;
                                                        var firstmem = data[a].dossier2;
                                                        var firstid1 = data[a].dossier3;
                                                        var firstMbr2 = data[a].etat1;
                                                        var firstid2 = data[a].etat2;
                                                        var firstMbr3 = data[a].etat3;
                                                        html += "<tr>";
                                                        html += "<td>"+firstidtri+"</td>";
                  ...
                  <button class='btn btn-outline-warning' type="submit">RAPPORT</button>
