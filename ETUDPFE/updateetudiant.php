...
<form  action="" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-3 border-right" style="background-color: #E6E6FA;">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="../avatars/<?php echo $_SESSION['avatar']?>"><span class="font-weight-bold"><?php echo $_SESSION['nom']?></span><span class="text-black-50"><?php echo $_SESSION['username']?></span><span> </span>
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12"><label class="labels">CNE</label><input type="text"name="cne" class="form-control" placeholder="enter CNE" value="<?php if(isset($_SESSION['CNE'])){echo $_SESSION['CNE'];}?>"></div>
        ...
        <div class="col-md-4">
            <div class="p-3 py-5">
                ...
                <div class="col-md-12"><label class="labels">Filiere</label><input type="text" disabled class="form-control" value="<?php echo  $_SESSION['filier']?>"></div>
                    <div class="col-md-12"><label class="labels">Niveau</label><input type="text" disabled class="form-control" value="<?php echo $_SESSION['niveau']?>"></div>
