...
<body>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="#"><i class="fa fa-user" style="color:black"></i>My Profile</a>
    ...
    border-bottom: 1px solid #b8bcfc;"><strong>Ajouter un nouveau </strong><small> sujet</small></div>
                            <div class="card-body">
                                <form method="GET" action="controller/addEtudiant.php">
                                    <div class="card-body card-block">
                                        <div class="form-group"><label for="company" class=" form-control-label">Sujet</label><input  class="form-control"type="text" id="company" name="libelle" value="" required></div>
                                        <div class="form-group"><label for="company" class=" form-control-label">Filiere</label> <?php
                                                                                                                        ?>
                                            <?php
                                            ...
                                            if (mysqli_num_rows($mysqli_result) > 0) {
                                                ...
                                                while ($rows = mysqli_fetch_assoc($mysqli_result)) {
                                                    $val = $rows["libelle"];
                                                    echo "<option value=$val >" . $rows["libelle"] . "</option>";
                                                }
                                                echo "</select>";
                                            }
                                            ?></div>
                                        ...
                                        <div class="form-group"><label for="company" class=" form-control-label">Niveau</label><select  class="form-control" id="company" name="niveau">
                                                <?php
                                                if (isset($_GET['niveau']))
                                                    echo '<option value=' . $_GET["niveau"] . '>' . $_GET["niveau"] . '</option>';
                                                ?>
                                                <option value="1er">1er année</option>
                                                <option value="2eme">2eme année</option>
                                                <option value="3eme">3eme année</option>
                                            </select></div>
                                        <div class="form-group"><label for="company" class=" form-control-label">Description</label><textarea name="description"  id="company"  class="form-control"rows="4" cols="20">
                                                                </textarea></div>

                                        <div class="form-group"><input type="submit" value="Valider" class="btn btn-outline-info"  style="background-color:#b8bcfc; color:black;border-color: #b8bcfc;"/></div>
