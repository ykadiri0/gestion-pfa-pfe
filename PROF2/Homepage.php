                            ...
                            <div class="card-body">
                                ...
                                <fieldset>
                                    ...
                                    <table id="bootstrap-data-table" class="table">
                                        <td> Niveau : </td>
                                        <td>
                                            <select name="niveau1" class="btn btn-outline-primary " id="niveau1" style="background-color:#b8bcfc; color:black;border-color: #b8bcfc;">
                                        ...
                                        ajax.onreadystatechange = function() {
                                            if (this.readyState == 4 && this.status == 200) {
                                                ...
                                                for (var a = 0; a < data.length; a++) {
                                                    var firstmem = data[a].niveau;
                                                    html += "<option value='"+firstmem+"'>" + firstmem + "</option>";
                                                }
                                                document.getElementById("niveau1").innerHTML = html;
                                            }
                                        }
        </script>
        <script>
            $("#niveau1").change(function () {
                          var l = document.getElementById("niveau1").value;
                          console.log(l);
                          var ajax = new XMLHttpRequest();
                          var method = "POST";
                          var url = "profe.php?niveau="+l;
                          var asynchronous = true;
                          ajax.open(method, url, asynchronous);
                          ajax.send();
                          ajax.onreadystatechange = function ()
                          {
                              if (this.readyState == 4 && this.status == 200) {
                                  ...
                                  for (var a = 0; a < data.length; a++) {
                                      ...
                                      html += "<td>" + p + "</td>";
                                      html+= "<td><button class='btn btn-outline-warning'><a href='ajoutUtilisateurs.php?id="+firstmem+"&nom="+firstid1+"&prenom="+firstMbr2+"&email="+firstid2+"&niveau="+firstMbr3+"&filiere="+firstid3+"'>modifier</a></button><button class='btn btn-outline-danger'><a href='php/deleteet.php?id="+firstmem+"'>supprimer</a></button></td>"
                                      html += "</tr>";
                                  }
