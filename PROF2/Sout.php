...
<body>
                            ...
                            <div class="card-body">
                                <form action="insert.php" method="GET">
                                    <div class="card-body card-block">
                                        ...
                                        <div class="form-group"><label for="company" class=" form-control-label">Projet name:</label> <select name="pn" class="form-control" style="width:600px;" id="data3"><option>-----------</option></div>
                                        <div class="form-group"><label for="company" class=" form-control-label">Projet name:</label> <select name="pn" class="form-control" style="width:600px;" id="data3"></div>



                                        <div class="form-group"><label for="company" class=" form-control-label">Rapport :
                                            </label>
                                            <input type="select"  name="PQ"  accept=".pdf,.docs,.txt"  class="form-control" style=" display: block; width: 58.9%;background-color: #e9ecef;
    opacity: 1; "  id="textfield" ><a href="#" download rel="noopener noreferrer" id="lien">
                                                Download File
                                            </a>

                                        </div>
                                        <script>
                                            document.getElementById("lien").onmouseenter = function() {
                                                var link = document.getElementById("lien");
                                                link.setAttribute("href", '../rpdf/'+document.getElementById("textfield").value);
                                                return false;
                                            }
                                        ...
                                        <div class="form-group"><label for="company" class=" form-control-label">La note :</label><input type="number" name="m2" class="form-control" style="width:200px;" id="data" /></div>
                                        <!-- <div class="form-group"><label for="company" class=" form-control-label">Projet name:</label> <select name="pn" class="form-control" style="width:600px;" id="data3"></div>
                                        <div class="form-group"><label for="company" class=" form-control-label">Projet name:</label> <select name="pn" class="form-control" style="width:600px;" id="data3"></div>
                                        ...
                                        <div class="form-group"><label for="company" class=" form-control-label">Rapport :
                                            ...
                                            <input type="text" name="PQ" class="form-control" disabled="disabled" value="" style=" display: block; width: 58.9%;" id="textfield"><a href="#"  download rel="noopener noreferrer" id="lien">
                                                Download File
                                            </a>
                                        ...
                                        <script>
                                            document.getElementById("lien").onmouseenter = function() {
                                                var link = document.getElementById("lien");
                                                link.setAttribute("href", document.getElementById("textfield").value);
                                                return false;
                                            }
    ...
    <script>
        var ajax = new XMLHttpRequest();
        var x="<?php echo$_SESSION["nom"].' '.$_SESSION["prenom"];?>";
        ...
        ajax.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                var html = "";
                for (var a = 0; a < data.length; a++) {
                    var firstName = data[a].Professeur;
                    var html2 = "";
                    html2 = PName
...
<script>
    var ajax = new XMLHttpRequest();
    var x="<?php echo$_SESSION["nom"].' '.$_SESSION["prenom"];?>";
        ajax.open("GET", "sujet.php?prof="+x, true);
        ajax.send();
    ajax.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            console.log(this.responseText);
