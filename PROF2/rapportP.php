        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-title">Menu Professeur</li>
                    <li>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="table-stats order-table ov-h">
                                    <table class="table ">
                                        <thead style="background-color: #b8bcfc;">
                                            <tr>
                                                <th class="serial">#</th>
                                                            ...
                                                            while ($rows = mysqli_fetch_assoc($result2)) {
                                                                ...
                                                                if (mysqli_num_rows($result) > 0) {
                                                                    while ($rows2 = mysqli_fetch_assoc($result)) {
                                                                        echo '
                                                                                <a href="#"><img   class="user-avatar rounded-circle" src="../avatars/' . $rows2['avatar'] . '" alt=""></a>
                                                                               ';
                                                                    }
                                                                }
                                                                echo '
                                                                ...
                                                                if (mysqli_num_rows($result5) > 0) {
                                                                    while ($rows5 = mysqli_fetch_assoc($result5)) {
                                                                        echo $rows5['nom'] . ' ' . $rows5['prenom'] . '<br>';
                                                                    }
                                                                }
