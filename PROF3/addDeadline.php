...
<body>
    ...
    border-bottom: 1px solid #b8bcfc;"><strong>Ajouter un nouveau Rendez</strong> <small>-vous</small></div>
                            ...
                            <?php
                                    ...
                                    if (isset($_GET['id'])){
                                     $id=$_GET['id'];
                                     $sql = 'SELECT * FROM AffProfEtud where id='.$id;
                                     $req = $pdo->query($sql);
                                    
                                    ?>
                                <form method="GET" action="insertPFE.php">
                                    ...
                                    <?php while ($row = $req->fetch()) { 
                                        ...
                                        <tr>
                                            <div class="form-group"><label for="company" class=" form-control-label">Id</label><input class="form-control" name="p1" rows="1" cols="20"  value="<?php echo $row['id'];?>" required></div>
                                        ...
                                        <tr>
                                            <div class="form-group"><label for="company" class=" form-control-label">Nom d'Etudiant</label><input class="form-control" name="p2" rows="1" cols="20"  value="<?php echo $row['etudiant'];?>"  required></div>
                                        ...
                                        <tr>
                                            <div class="form-group"><label for="company" class=" form-control-label">Entreprise</label><input class="form-control" name="p3" rows="1" cols="20"  value="<?php echo $row['entreprise'];?>"  required></div>


                                        </tr>
                                        <tr>
                                            <div class="form-group"><label for="company" class=" form-control-label">Encadrant</label><input class="form-control" name="p4" rows="1" cols="20"   value="<?php echo  $_SESSION['nom'] . " " . $_SESSION['prenom'] ?>"  required></div>


                                        </tr>
                                        <div class="form-group"><label for="company" class=" form-control-label">deadline</label><input class="form-control" type="date" name="p5" value="" required /></div>
